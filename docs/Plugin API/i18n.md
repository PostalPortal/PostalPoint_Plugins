...
* [i18n](#i18n) : <code>object</code>
    ...
    * [.getUILanguage(full)](#i18n.getUILanguage) ⇒ <code>string</code>
    * [.getCustomerLanguage(full)](#i18n.getCustomerLanguage) ⇒ <code>string</code>
...
<a name="i18n.getUILanguage"></a>

### i18n.getUILanguage(full) ⇒ <code>string</code>
...
| Param | Type | Description |
| --- | --- | --- |
| full | <code>boolean</code> | True to return entire code (for example, "en_US"), false to return just the language (example: "en"). Default is true. |

<a name="i18n.getCustomerLanguage"></a>

### i18n.getCustomerLanguage(full) ⇒ <code>string</code>
Get the store-specified customer-facing language code. Same behavior as getUILanguage.
